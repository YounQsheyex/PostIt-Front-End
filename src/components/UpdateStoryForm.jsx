...
const UpdateStoryForm = () => {
  ...
  return (
    <div className="w-sm lg:w-[1240px] mx-auto p-5 lg:p-0 mt-7">
      <form>
        ...
        <div>
          ...
          <textarea
            id="story"
            className="w-full lg:w-[1239px] h-[568px] rounded-[5px] border-[1px] border-[#dddddd] px-4 py-2 focus:outline-none"
          ></textarea>
        </div>
